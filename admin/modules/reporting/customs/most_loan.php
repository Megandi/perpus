...
<?php
    ...
    $reportgrid->setSQLColumn('i.item_code AS \''.__('Item Code').'\'','b.title AS \''.__('Title').'\'','COUNT(i.item_code) AS \''.__('Total').'\'');

    // is there any search
    $criteria = 'l.item_code IS NOT NULL';
